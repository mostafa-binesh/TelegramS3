...
- Telegram settings saves validate numeric API/storage identifiers before persistence and report refresh failures through JSON responses instead of surfacing as proxy 502s

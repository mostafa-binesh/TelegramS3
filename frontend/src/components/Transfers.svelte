...
<style>small{display:block;font-size:11px;color:var(--muted);margin-top:7px;overflow-wrap:anywhere}table{width:100%;min-width:620px;border-collapse:collapse;font-size:13px}th{text-align:left;font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.08em}td,th{padding:18px 12px;border-bottom:1px solid var(--border);vertical-align:top}td:first-child{max-width:300px}td button{padding:6px 10px;margin:2px;font-size:12px}.state{display:inline-block;padding:5px 9px;background:#fff1d5;border-radius:5px;font-size:12px}.state.done{background:#dcf5e9;color:#17604a}progress{max-width:160px;accent-color:var(--accent)}.table-scroll{max-width:100%;overflow:auto;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}.empty{padding:32px 0;color:var(--muted)}.pagination{display:flex;gap:16px;align-items:center;justify-content:flex-end;margin-top:20px;font-size:12px}@media(max-width:480px){.pagination{justify-content:space-between;gap:8px}.pagination button{padding-right:.7rem;padding-left:.7rem}}</style>
